...
function visPersoner() 
{
  ...
  <table>
        <tr>
              <td>
                <input type="checkbox"onclick="velgAlleEllerIngen(this.checked)"
                ${lagHtmlChecked(model.personer.velgAlle)}/>
              </td>
      ...
      for (let person of model.personer.liste) 
      {
        ...
        <tr>
            <td>
              <input type="checkbox"onclick="velgPerson(${person.id})" ${lagHtmlChecked(person.erValgt)}"/>
            </td>
            ...
            <td>
              <button class="litenKnapp"  onclick="slettPerson(${person.id})">x</button>
            </td>
        </tr>`;
      }
